...
CREATE TABLE IF NOT EXISTS `sigcodb`.`Personal` (
  ...
  PRIMARY KEY (`codigo`),
  INDEX `fk_personal_pais_idx` (`codPais` ASC),
  ...
  INDEX `fk_personal_profesion_idx` (`codProfesion` ASC),
  CONSTRAINT `fk_personal_pais`
    FOREIGN KEY (`codPais`)
    REFERENCES `sigcodb`.`Pais` (`Codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_personal_barrio`
    ...
    REFERENCES `sigcodb`.`Barrio` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_personal_profesion`
    FOREIGN KEY (`codProfesion`)
    REFERENCES `sigcodb`.`Profesion` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sigcodb`.`motivoBaja`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`motivoBaja` (
  `codigo` VARCHAR(5) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sigcodb`.`cargo_salario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`cargo_salario` (
  `codigo` VARCHAR(5) NOT NULL,
  ...
  CONSTRAINT `fk_Cargo_has_Personal_Personal1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cargo_motivBaja`
    FOREIGN KEY (`codMotivo`)
    REFERENCES `sigcodb`.`motivoBaja` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigcodb`.`Cliente` (
  ...
  `isdeuda` INT NULL DEFAULT 0 COMMENT 'Indica si un cliente tiene deuda pendiente o cancelado\n0 - no tiene deuda pendiente\n1 - tiene deuda pendiente',
  `isSolicitud` INT(1) NULL DEFAULT 0 COMMENT 'Este campo sirve para distingir si un cliente tiene o no solicitudes pendientes\nvalores:\n0 sin solicitud pendiente\n1 solicitud pendiente',
  `obs` TEXT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_cliente_cobrador_idx` (`codVendedor` ASC),
  INDEX `fk_cliente_pais_idx` (`codPais` ASC),
  ...
  INDEX `fk_cliente_profesion_idx` (`codProfesion` ASC),
  CONSTRAINT `fk_cliente_vendedor`
    FOREIGN KEY (`codCobrador`)
    REFERENCES `sigcodb`.`cargo_salario` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_cliente_barrio`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_clinte_sucursal`
    FOREIGN KEY (`codSucursal`)
    REFERENCES `sigcodb`.`Sucursal` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `sigcodb`.`Rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`Rol` (
  `codigo` VARCHAR(5) NOT NULL,
  `rol` VARCHAR(45) NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigcodb`.`Usuario` (
  ...
  `codRol` VARCHAR(5) NULL COMMENT 'nivel de acceso',
...
-- -----------------------------------------------------
-- Table `sigcodb`.`Ventana`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`Ventana` (
  `codigo` VARCHAR(5) NOT NULL,
  `ventana` VARCHAR(45) NULL,
  `codModulo` VARCHAR(5) NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_ventana_modulo_idx` (`codModulo` ASC),
  CONSTRAINT `fk_ventana_modulo`
    FOREIGN KEY (`codModulo`)
    REFERENCES `sigcodb`.`Modulo` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigcodb`.`Acceso` (
  ...
  `codRol` VARCHAR(5) NULL,
  `codModulo` VARCHAR(5) NULL,
  `codVentana` VARCHAR(5) NULL,
  `acceso` INT NULL,
  `nuevo` INT NULL,
  `actualizar` INT NULL,
  `borrar` INT NULL,
  ...
  CONSTRAINT `fk_acceso_ventana`
    ...
    REFERENCES `sigcodb`.`Ventana` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigcodb`.`SolicitudCredito` (
  ...
  INDEX `fk_slicitud_cliente_idx` (`codCliente` ASC),
  CONSTRAINT `fk_slicitud_cliente`
    FOREIGN KEY (`codCliente`)
    REFERENCES `sigcodb`.`Cliente` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sigcodb`.`referencia` (
  ...
  `codCliente` VARCHAR(10) NULL,
  `ci_ruc` VARCHAR(15) NULL,
  `nombre` VARCHAR(60) NULL,
  `direccion` VARCHAR(45) NULL,
  `contacto` VARCHAR(45) NULL,
  `obs` TEXT(120) NULL,
  `tipoRef` ENUM('P', 'C') NULL COMMENT 'P: REFERENCIA PERSONAL\nC: REFERENCIA COMERCIAL',
  PRIMARY KEY (`codigo`),
  INDEX `fk_referencia_cliente_idx` (`codCliente` ASC),
...
-- -----------------------------------------------------
-- Table `sigcodb`.`asignacionZona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`asignacionZona` (
  `codZona` VARCHAR(5) NOT NULL,
  `codCiudad` VARCHAR(5) NOT NULL,
  `obs` VARCHAR(70) NULL,
  PRIMARY KEY (`codZona`, `codCiudad`),
  INDEX `fk_Zona_has_Ciudad_Ciudad1_idx` (`codCiudad` ASC),
  INDEX `fk_Zona_has_Ciudad_Zona1_idx` (`codZona` ASC),
  CONSTRAINT `fk_Zona_has_Ciudad_Zona1`
    FOREIGN KEY (`codZona`)
    REFERENCES `sigcodb`.`Zona` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Zona_has_Ciudad_Ciudad1`
    FOREIGN KEY (`codCiudad`)
    REFERENCES `sigcodb`.`Ciudad` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sigcodb`.`Rol_modulo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sigcodb`.`Rol_modulo` (
  `Rol_codigo` VARCHAR(5) NOT NULL,
  `Modulo_codigo` VARCHAR(5) NOT NULL,
  INDEX `fk_Rol_has_Modulo_Modulo1_idx` (`Modulo_codigo` ASC),
  INDEX `fk_Rol_has_Modulo_Rol1_idx` (`Rol_codigo` ASC),
  CONSTRAINT `fk_Rol_has_Modulo_Rol1`
    FOREIGN KEY (`Rol_codigo`)
    REFERENCES `sigcodb`.`Rol` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Rol_has_Modulo_Modulo1`
