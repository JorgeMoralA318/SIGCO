...
public class tablaMotivoBaja {

    motivoBajaVista vista;
    DefaultTableModel modelo;
    PreparedStatement ps = null;
    String[] titulosColumnas = {"Código","Motivo Baja"};
...
//controlador de la tabla, opcionalmente se puede colocar dentro del formulario o en una nueva clase
    ...
    public void buscar(String buscar) {
        ...
        String sql = "select * from motivoBaja where motivo like ?";
