...
public class tablaCiudad{
   ...
   ciudadVista vista;
    ...
    String[] titulosColumnas = {"Código Ciudad","Ciudad","Departamento"};
...
//controlador de la tabla, opcionalmente se puede colocar dentro del formulario o en una nueva clase
    ...
    public void buscar(String buscar) {
        ...
        String sql = "SELECT a.codigociudad,a.ciudad,b.departamento\n" +
"FROM ciudad a INNER JOIN departamento b\n" +
"ON a.codigodpto= b.codigodpto WHERE a.ciudad LIKE ?";
