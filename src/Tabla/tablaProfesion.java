...
public class tablaProfesion {

    profesionVista vista;
    DefaultTableModel modelo;
    PreparedStatement ps = null;
    String[] titulosColumnas = {"Código", "Profesión",};
...
//controlador de la tabla, opcionalmente se puede colocar dentro del formulario o en una nueva clase
    ...
    public void buscar(String buscar) {
        ...
        String sql = "SELECT codigo, Profesion FROM Profesion WHERE Profesion LIKE ?";
