 ...
 * @author Helena
 */
public class barrioVista extends javax.swing.JFrame {
  ...
  cambiarform();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(barrioVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new barrioVista().setVisible(true);
            }
        });
    }
