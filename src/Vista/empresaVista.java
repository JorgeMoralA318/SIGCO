...
public class empresaVista extends javax.swing.JFrame {
    ...
    tablaEmpresa tab = new tablaEmpresa();
    ...
    void cambiarform() {
        ...
        form.setTitle("Mantenimiento Empresa");
        String var = this.lblejecucion.getText();
            ...
            if (filaSeleccionada == -1) {
                ...
                switch (control) {
                    case "":
                        ...
                        break;
                    case "Sucursal":
                        form1.txtcodempresa.setText(codigo);
                        break;
