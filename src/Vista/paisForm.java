...
public class paisForm extends javax.swing.JFrame {
    ...
    private void obtener_codigo() {
        dao = new PaisDAO();
        txtcodigo.setText("P-" + dao.obtener_id());
        txtcodigo.requestFocus();
    }

    public void listarCodigo(String codigo) {
        ArrayList<PaisVO> list = dao.Listar_PaisVO(codigo);
        if (list.size() > 0) {
