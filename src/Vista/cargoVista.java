 ...
 * @author Helena
 */
public class cargoVista extends javax.swing.JFrame {
    ...
    void cambiarform() {
        ...
        form.setTitle("Mantenimiento Cargo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cargoVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cargoVista().setVisible(true);
            }
        });
    }
