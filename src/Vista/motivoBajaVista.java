 ...
 * @author Helena
 */
public class motivoBajaVista extends javax.swing.JFrame {

    tablaMotivoBaja tab = new tablaMotivoBaja();
    motivoBajaForm form = new motivoBajaForm();

    public motivoBajaVista() {
        initComponents();
        mostrar("");
        mostrarFechaHora();
    }
    ...
    private void initComponents() {
        ...
        lblprograma.setText("Motivo Baja");
  ...
  cambiarform();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(motivoBajaVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new motivoBajaVista().setVisible(true);
            }
        });
    }
