 ...
 * @author Helena
 */
public class profesionVista extends javax.swing.JFrame {
    ...
    void cambiarform(){
        ...
        form.setTitle("Mantenimiento Profesion");
  ...
  cambiarform();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(profesionVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new profesionVista().setVisible(true);
            }
        });
    }
